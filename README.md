...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/vauxa)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/vauxa
```

A live public deployment of this template is available at [https://vauxa.templates.workers.dev](https://vauxa.templates.workers.dev)
